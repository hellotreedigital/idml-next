    ...
    return (
        <>
            <div className="">
                ...
                <div className="position-absolute pin-location" style={{ top: props.y + '%', left: props.x + '%' }} onClick={() => pinClick(props.pinLocation)}>
                    <img ref={pinRef} className={" pins pin-delay" + (props.pinLocation.operations_map_legend_id === 2 ? " pin-home" : " ")} src={props.pin} alt="pin" animate="" style={{ transitionDelay: props.index * 0.1 + 's' }}  />
