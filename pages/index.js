  ...
  return loading ? null : (
    <Layout activePage="home">
      ...
      <div className="position-relative">
        ...
        <div className="ratio background-image">
          <video playsInline muted loop autoPlay>
            <source src="../img/temp-images/video-home.mp4" type='video/mp4' />
          </video>
        </div>
        ...
        <div className="container py-5" animate="left">
          <div className="row justify-content-center text-center ">
            <div className="col-lg-8">
              <h2 className="pb-4 mb-0">WHAT WE DO</h2>
              <p className="home-paragraph mb-0">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>
            </div>
          </div>
        </div>
        ...
        <div className="container pt-5" animate="right">
          <div className="row justify-content-center text-center ">
            <div className="col-lg-8 pb-4" >
              <h2 className="mb-0">OUR PROCESS</h2>
            </div>
          </div>
          <div className="row justify-content-center ">
            <div className="col-lg-4 col-md-6 col-12 pb-lg-0 pb-5">
              <div className="bg-color button blue-button-hover shadow">
                ...
                <div className="onhover-text pt-3">
                  <p className="mb-0 mx-lg-3">We provide a client-centered approach by treating your brand or your business with care as if it was our own.</p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-12 pb-lg-0 pb-5">
        ...
        <div className="row justify-content-center  align-items-center pb-3" >
          <div className="col-lg-12">
            <div className="d-flex text-center justify-content-center">
              <h2 className="mb-0">OUR CLIENTS</h2>
            </div>
          </div>
        </div>
        ...
        >
            ...
            <div>
              <div className="brand-logo-section shadow position-relative m-3">
                <div className="ratio ratio-1x1">
                  <img src="../img/temp-images/brand-logo1.png" alt="brand-logo" />
                </div>
          ...
          <SwiperSlide>
            <div>
              <div className="brand-logo-section shadow position-relative m-3 ">
                <div className="ratio ratio-1x1">
                  <img src="../img/temp-images/brand-logo2.png" alt="brand-logo" />
                </div>
                <div className="overlay"></div>
                <div className="text-on-overlay text-center">
                  <h2 className="mb-3">TITLE HERE</h2>
          ...
          <SwiperSlide>
            <div>
              <div className="brand-logo-section shadow position-relative m-3">
                <div className="ratio ratio-1x1">
                  <img src="../img/temp-images/brand-logo3.png" alt="brand-logo" />
                </div>
                <div className="overlay"></div>
                <div className="text-on-overlay text-center">
                  <h2 className="mb-3">TITLE HERE</h2>
          ...
          <SwiperSlide>
            <div>
              <div className="brand-logo-section shadow position-relative m-3">
                <div className="ratio ratio-1x1">
                  <img src="../img/temp-images/brand-logo4.png" alt="brand-logo" />
                </div>
                <div className="overlay"></div>
                <div className="text-on-overlay text-center">
                  <h2 className="mb-3">TITLE HERE</h2>
          ...
          <SwiperSlide>
            <div>
              <div className="brand-logo-section shadow position-relative m-3">
                <div className="ratio ratio-1x1">
                  <img src="../img/temp-images/brand-logo5.png" alt="brand-logo" />
                </div>
                <div className="overlay"></div>
                <div className="text-on-overlay text-center">
                  <h2 className="mb-3">TITLE HERE</h2>
      ...
      <div className="container pt-5" animate="left">
        <div className="row justify-content-center text-center ">
          <div className="col-lg-8 pb-4" >
            <h2 className="mb-0">INDUSTRIES</h2>
          </div>
        </div>
        <div className="row justify-content-center ">
      ...
      <div className="container pt-5" animate="left">
        <div className="row  justify-content-center  align-items-center ">
          <div className="col-lg-12 col-md-8 col-sm-12 col-12" >
            <div className="d-flex text-center justify-content-center">
              <h2 className="mb-2" >BUSINESS TIPS</h2>
            </div>
          </div>
        </div>
        <div className="row justify-content-center" >
          <div className="col-lg-6 text-center">
            <p className="tips-home mb-3">Subscribe to our YouTube channel  to stay up-to-date with the latest business trends. </p>
          </div>
        </div>

        <div className="row justify-content-center ">
          <div className="col-lg-3 col-md-4 col-sm-6 pb-5 ">
            <div className="youtube-section position-relative shadow" onClick={() => setYoutubePopup(true)}>
              <div className="ratio youtube-ratio">
                <img src="../img/temp-images/youtube1.jpg" alt="youtube" />
              </div>
            ...
            <div className="under-box pt-3">
              <h3 className="mb-1">21 DEC 21</h3>
              <h4 className="mb-0">IDML Group is committed to delivering the best possible service.</h4>
            </div>
          </div>
          <div className="col-lg-6 col-md-4 col-sm-6 pb-5" >
            <div className="youtube-section position-relative shadow" onClick={() => setYoutubePopup(true)}>
              <div className="ratio youtube-section-longer">
                <img src="../img/temp-images/youtube1.jpg" alt="youtube" />
              </div>
              <div className="overlay-youtube larger"></div>
              <div className="youtube-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="47.861" height="47.861" viewBox="0 0 47.861 47.861">
                  <path className="fill-icon" id="fi-rr-play-alt" d="M37.89,47.861H9.971A9.983,9.983,0,0,1,0,37.89V9.971A9.983,9.983,0,0,1,9.971,0H37.89a9.983,9.983,0,0,1,9.971,9.971V37.89A9.983,9.983,0,0,1,37.89,47.861ZM9.971,3.988A5.983,5.983,0,0,0,3.988,9.971V37.89a5.983,5.983,0,0,0,5.983,5.983H37.89a5.983,5.983,0,0,0,5.983-5.983V9.971A5.983,5.983,0,0,0,37.89,3.988ZM18.63,33.911a4.722,4.722,0,0,1-2.365-.644,4.613,4.613,0,0,1-2.321-4.03V18.624a4.66,4.66,0,0,1,6.98-4.046l10.525,5.255a4.658,4.658,0,0,1,.1,8.144L20.825,33.335A4.387,4.387,0,0,1,18.63,33.911Zm-.05-15.954a.626.626,0,0,0-.313.084.652.652,0,0,0-.335.582V29.237a.672.672,0,0,0,1,.584l10.721-5.36a.626.626,0,0,0,.239-.53.648.648,0,0,0-.337-.582L19.035,18.093a.921.921,0,0,0-.455-.136Z" fill="#14334a" />
                </svg>
